...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        sistemaRegistroPersonas personas = new sistemaRegistroPersonas();
        while(true){
            ...
            if(opcionElegida.equals("A") || opcionElegida.equals("a")){
                ...
                personas = new sistemaRegistroPersonas(p1);
            }
                ...
                size = personas.getSize();

                while(counter < size){
                    Persona paux = personas.getPosition(counter);
                    int dniComparacion = paux.getDni();
                    if(dni == dniComparacion){
                        personas.Remove(counter);
                    }
                    counter ++;
                }
            }
                ...
                while(counter < size){
                    ...
                    if(dniI == dniComparacion){
                        Persona paux1 = personas.getPosition(counter);
                        personas.Remove(counter);
                        ...
                        personas = new sistemaRegistroPersonas(paux1);
                    }
                    counter ++;
                }
            }
                ...
                while(counter < size){
                    paux = personas.getPosition(counter);
